...
### Initial States ###
LLO_initial_state_moon = LLO_initial_states.initial_state_pathfinder
Moon_ini = X_Moon[0, :]
LLO_initial_state = np.add(LLO_initial_state_moon, Moon_ini)
...
plt.figure()
plt.plot(states_LLOsat[:, 0], states_LLOsat[:, 1])
