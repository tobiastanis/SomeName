...
Difference_scenario3_norm = np.linalg.norm(Difference_scenario3[:, 0:3], axis=1)

print('Maximum difference in scenario 1: \n', max(Difference_scenario3_norm), 'm')
endtime = datetime.now()

print('Scenario 3 duration: {}'.format(endtime - starttime))
