"""
Earth and Moon are given as pointmasses to see if there is a difference with spherical harmonic gravity type
"""
...
print("Running [Earth_Moon_PointmassPropagation.py]")
...
body_system.get("LLOsat").mass = 280
...
environment_setup.add_radiation_pressure_interface(body_system, "LLOsat",radiation_pressure_settings)
...
print("[Earth_Moon_PointmassPropagation.py] successfully ran \n")