...
ax1.plot(x_llosat[:, 0], x_llosat[:, 1], color='lime')
...
ax2.plot(x_llosat[:, 0], x_llosat[:, 2], color='lime')
...
ax3.plot(x_llosat[:, 1], x_llosat[:, 2], color='lime')
...
bx1.plot(x_llosat_moon[:, 0], x_llosat_moon[:, 1], color='lime')
bx1.plot(0, 0, marker='o', markersize=7, color='grey')
bx1.plot(x_llosat_moon[0, 0], x_llosat_moon[0, 1], marker='o', markersize=3, color='green')
bx1.set_title('Trajectory in xy-plane')
bx1.set_xlabel('x-direction [km]')
bx1.set_ylabel('y-direction [km]')
bx2.plot(x_llosat_moon[:, 0], x_llosat_moon[:, 2], color='lime')
bx2.plot(0, 0, marker='o', markersize=7, color='grey')
bx2.plot(x_llosat_moon[0, 0], x_llosat_moon[0, 2], marker='o', markersize=3, color='green')
...
bx3.plot(x_llosat_moon[:, 1], x_llosat_moon[:, 2], color='lime')
bx3.plot(0, 0, marker='o', markersize=7, color='grey')
bx3.plot(x_llosat_moon[0, 1], x_llosat_moon[0, 2], marker='o', markersize=3, color='green')
