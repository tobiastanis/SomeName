...
bx1.plot(LUMIO_states[:, 0]*10**-3, LUMIO_states[:, 1]*10**-3, color='orange')
bx1.plot(LUMIO_dataset_states[:, 0]*10**-3, LUMIO_dataset_states[:, 1]*10**-3, color='red')
bx1.plot(X_Moon[:, 0]*10**-3, X_Moon[:, 1]*10**-3, color='grey')
bx1.plot(X_Moon[0, 0]*10**-3, X_Moon[0, 1]*10**-3, marker='o', markersize=7, color='grey')
bx1.plot(0, 0, marker='o', markersize=10, color='blue')
bx1.plot(LUMIO_states[0, 0]*10**-3, LUMIO_states[0, 1]*10**-3, marker='o', markersize=5, color='orange')
bx1.plot(LUMIO_dataset_states[0, 0]*10**-3, LUMIO_dataset_states[0, 1]*10**-3, marker='o', markersize=5, color='red')
bx1.set_title('2D-system view in xy-plane')
bx1.set_xlabel('x-direction [km]')
bx1.set_ylabel('y-direction [km]')
bx2.plot(LUMIO_states[:, 0]*10**-3, LUMIO_states[:, 2]*10**-3, color='orange')
bx2.plot(LUMIO_dataset_states[:, 0]*10**-3, LUMIO_dataset_states[:, 2]*10**-3, color='red')
bx2.plot(X_Moon[:, 0]*10**-3, X_Moon[:, 2]*10**-3, color='grey')
bx2.plot(0, 0, marker='o', markersize=10, color='blue')
bx2.plot(X_Moon[0, 0]*10**-3, X_Moon[0, 2]*10**-3, marker='o', markersize=7, color='grey')
bx2.plot(LUMIO_states[0, 0]*10**-3, LUMIO_states[0, 2]*10**-3, marker='o', markersize=5, color='orange')
bx2.plot(LUMIO_dataset_states[0, 0]*10**-3, LUMIO_dataset_states[0, 2]*10**-3, marker='o', markersize=5, color='red')
bx2.set_title('2D-system view in xz-plane')
bx2.set_xlabel('x-direction [km]')
bx2.set_ylabel('z-direction [km]')
bx3.plot(LUMIO_states[:, 1]*10**-3, LUMIO_states[:, 2]*10**-3, color='orange')
bx3.plot(LUMIO_dataset_states[:, 1]*10**-3, LUMIO_dataset_states[:, 2]*10**-3, color='red')
bx3.plot(X_Moon[:, 1]*10**-3, X_Moon[:, 2]*10**-3, color='grey')
bx3.plot(X_Moon[0, 1]*10**-3, X_Moon[0, 2]*10**-3, marker='o', markersize=7, color='grey')
bx3.plot(0, 0, marker='o', markersize=10, color='blue')
bx3.plot(LUMIO_states[0, 1]*10**-3, LUMIO_states[0, 2]*10**-3, marker='o', markersize=5, color='orange')
bx3.plot(LUMIO_dataset_states[0, 1]*10**-3, LUMIO_dataset_states[0, 2]*10**-3, marker='o', markersize=5, color='red')
bx3.set_title('2D-system view in yz-plane')
bx3.set_xlabel('y-direction [km]')
bx3.set_ylabel('z-direction [km]')
bx2.legend(['Simulated states', 'Database states', 'Moon trajectory', 'Earth'], loc='upper left', bbox_to_anchor=(1, 1))
